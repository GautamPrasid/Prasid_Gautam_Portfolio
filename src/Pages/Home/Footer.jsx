  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--items">
          <ul>
            ...
            <li>
              {/* Testimonials link removed because Testimonials section was deleted */}
            </li>
          </ul>
        </div>
        <div className="footer--social--icon">
          <ul>
            ...
            <li>
              <a
                href="  https://www.facebook.com/prasid.gautam/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/prasid-gautam-6222a7273/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">© {new Date().getFullYear()} Gautam Prasid</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
